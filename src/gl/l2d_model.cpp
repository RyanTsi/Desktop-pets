...
void L2dModel::LoadAssets(const Csm::csmChar* dir, const  Csm::csmChar* fileName)
{
    _modelHomeDir = dir;
    if (_debugMode)
...
void L2dModel::SetupTextures()
{
    for (csmInt32 modelTextureNumber = 0; modelTextureNumber < _modelSetting->GetTextureCount(); modelTextureNumber++)
    {
        ...
        TexManager::TextureInfo* texture = _texManager->CreateTextureFromPngFile(texturePath.GetRawString());
